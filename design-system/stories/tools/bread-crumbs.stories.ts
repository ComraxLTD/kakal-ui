...
// import { IBreadCrumb } from '../../projects/kakal-ui/src/lib/bread-crumbs/bread-crumbs.model';
// import { of } from 'rxjs';
...
// breadCrumbs.args = {
//     breadCrumbs$: of([
//     new IBreadCrumb({url:'asd',label:'התקשרויות'}),
//     new IBreadCrumb({url:'asd',label:'דרגה שניה'}),
//     new IBreadCrumb({url:'asd',label:'דרגה שלישית'}),
//   ]),
