...
import { RouterService } from '../app/utilities/services/route.rservice';
...
export default {
  ...
  decorators: [
    moduleMetadata({
      declarations: [MenuItemComponent, CardUserComponent, TypographyComponent, IconComponent, SizeDirective, ColorDirective, ClassesDirective],
      providers: [MenuService, RouterService { provide: APP_BASE_HREF, useValue: '/' }],
      imports: [
        CommonModule,
        AppRoutingModule,
        MaterialModule,
