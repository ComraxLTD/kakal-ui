...
let LayoutExComponent = class LayoutExComponent {
    ...
    setHeaders() {
        return this.routerService
            .getModulePrefixObs().pipe(distinctUntilChanged(), map((path) => this.headers[path]));
    }
    subscribeToRouter() {
    ...
    setWizard() {
        return this.routerService
            .getModulePrefixObs().pipe(map((path) => {
    ...
    setMenu() {
        ...
        return modulePath$.pipe(switchMap((modulePath) => {
            return lastPath$.pipe(map((path) => {
...
LayoutExComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    ...
    (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__param)(5, Inject(PROJECT_PREFIX)),
    (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__metadata)("design:paramtypes", [typeof (_a = typeof LandService !== "undefined" && LandService) === "function" ? _a : Object, typeof (_b = typeof _components_menu_menu_service__WEBPACK_IMPORTED_MODULE_0__.MenuService !== "undefined" && _components_menu_menu_service__WEBPACK_IMPORTED_MODULE_0__.MenuService) === "function" ? _b : Object, typeof (_c = typeof _components_navbar_navbar_service__WEBPACK_IMPORTED_MODULE_1__.NavbarService !== "undefined" && _components_navbar_navbar_service__WEBPACK_IMPORTED_MODULE_1__.NavbarService) === "function" ? _c : Object, typeof (_d = typeof LayoutService !== "undefined" && LayoutService) === "function" ? _d : Object, typeof (_e = typeof RouterService !== "undefined" && RouterService) === "function" ? _e : Object, String])
], LayoutExComponent);
...
//# sourceMappingURL=main.ddffced4e904849bd0f0.hot-update.js.map