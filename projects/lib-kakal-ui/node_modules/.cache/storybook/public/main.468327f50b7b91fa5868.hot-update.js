...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs/operators */ "../../node_modules/rxjs/_esm2015/internal/operators/switchMap.js");
...
let LayoutExComponent = class LayoutExComponent {
    ...
    setWizard() {
        return this.routerService.getModulePrefixObs().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)((path) => {
    ...
    setMenu() {
        ...
        return modulePath$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)((modulePath) => {
            return lastPath$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)((path) => {
...
//# sourceMappingURL=main.468327f50b7b91fa5868.hot-update.js.map